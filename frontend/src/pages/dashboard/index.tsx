    ...
    <>
      <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-white">Pending Solutions</h2>
        ...
        {loading ? (
          <div className="text-center py-4">
            ...
            <p className="text-gray-400 mt-2">Loading pending solutions...</p>
          </div>
        ) : solutions.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-400">No pending solutions</p>
          </div>
        ) : (
          <div className="space-y-2">
            {solutions.map((solution) => (
              <motion.div
                ...
                className="bg-gray-800 rounded-lg p-3 border border-gray-600 hover:border-gray-500 transition-colors cursor-pointer"
                onClick={() => {
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <h3 className="font-medium text-white text-sm">{solution.title}</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">{selectedSolution.category} - {selectedSolution.subcategory}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Industry</h3>
                    <p className="text-gray-300">{selectedSolution.industry}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-4">
                      <p className="text-gray-300">Name: {selectedSolution.vendorId.firstName} {selectedSolution.vendorId.lastName}</p>
                      <p className="text-gray-300">Email: {selectedSolution.vendorId.email}</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-4">
                      <p className="text-gray-300">Company: {selectedSolution.companyId.name}</p>
                      <p className="text-gray-300">Verified: {selectedSolution.companyId.isVerified ? 'Yes' : 'No'}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
              <div className="text-2xl font-bold text-blue-400">{stats.roles.vendor || 0}</div>
              <div className="text-sm text-gray-400">Vendors</div>
            </div>
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
              <div className="text-2xl font-bold text-green-400">{stats.roles.customer || 0}</div>
              <div className="text-sm text-gray-400">Customers</div>
            </div>
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
              <div className="text-2xl font-bold text-purple-400">{stats.roles.superadmin || 0}</div>
          ...
          <div className="space-y-3">
            {users.map((user) => (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-gray-800 rounded-lg p-4 border border-gray-600 hover:border-gray-500 transition-colors cursor-pointer"
                onClick={() => {
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-300 mb-1">{user.email}</p>
...
const UserStatsSection: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-white">User Statistics</h2>
        <UserGroupIcon className="h-5 w-5 text-blue-400" />
      </div>
      ...
      {stats && (
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-blue-400 font-medium">Vendors:</span>
            <span className="text-2xl font-bold text-blue-400">{stats.roles.vendor || 0}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-green-400 font-medium">Customers:</span>
            <span className="text-2xl font-bold text-green-400">{stats.roles.customer || 0}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-purple-400 font-medium">Admins:</span>
            <span className="text-2xl font-bold text-purple-400">{stats.roles.superadmin || 0}</span>
          </div>
        </div>
      )}
    </div>
        ...
        <div className="min-h-screen bg-gray-800 flex items-center justify-center">
          <div className="max-w-md w-full mx-auto text-center">
            <div className="bg-gray-900 rounded-2xl p-8 border border-gray-700">
              ...
              <h1 className="text-2xl font-bold text-white mb-2">Welcome to AstralAI</h1>
              <p className="text-gray-300 mb-6">Sign in to access your personalized dashboard and discover AI solutions.</p>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-transparent border border-gray-600 text-gray-300 font-semibold py-3 px-6 rounded-lg hover:bg-gray-700 hover:text-white transition-all duration-200"
                >
                  Create Account
                </button>
              </div>
              ...
              <p className="text-sm text-gray-400 mt-6">
                New to AstralAI? <span className="text-blue-400 hover:text-blue-300 cursor-pointer">Learn more about our platform</span>
              </p>
            </div>
          </div>
        </div>
    ...
    >
      <div className="bg-gray-800 min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-gray-300">{welcome.subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statsCards.map((stat, index) => (
            <motion.div
              ...
              className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6"
            >
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="flex items-center space-x-3 p-4 rounded-lg border border-gray-700 hover:border-blue-500 hover:bg-gray-800 transition-colors text-left"
                  >
            ...
            {featuredSolutions.length > 0 && (
              <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-white">Featured Solutions</h2>
                  <button
                ...
                <div className="space-y-4">
                  {featuredSolutions.slice(0, 3).map((solution: any) => (
                    <div
                      key={solution._id}
                      className="flex items-center space-x-4 p-4 rounded-lg border border-gray-700 hover:border-blue-500 cursor-pointer transition-colors"
                      onClick={() => router.push(`/solutions/${solution._id}`)}
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg flex items-center justify-center">
                        <SparklesIcon className="h-6 w-6 text-blue-400" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-white truncate">{solution.title}</h3>
                        <p className="text-sm text-gray-300 truncate">{solution.shortDescription}</p>
                        <div className="flex items-center space-x-4 mt-1">
                          <span className="text-sm text-gray-400">{solution.category}</span>
                          <span className="text-sm text-gray-400">{solution.industry}</span>
                          {solution.rating && (
                            <div className="flex items-center space-x-1">
                              <span className="text-sm font-medium text-white">
                                {solution.rating.average.toFixed(1)}
                              </span>
                              <span className="text-sm text-gray-400">({solution.rating.count})</span>
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
                ...
                <div className="space-y-4">
                  {activeQueries.slice(0, 3).map((query: any) => (
                    <div
                      key={query._id}
                      className="flex items-start space-x-4 p-4 rounded-lg border border-gray-700"
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg flex items-center justify-center">
                        <DocumentTextIcon className="h-6 w-6 text-blue-400" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-white truncate">{query.title}</h3>
                        <p className="text-sm text-gray-300 line-clamp-2 mt-1">{query.description}</p>
                        <div className="flex items-center space-x-4 mt-2">
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-900 text-green-300">
                            {query.status}
                          </span>
                          <span className="text-sm text-gray-400">{query.category}</span>
                          <span className="text-sm text-gray-400">{query.industry}</span>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          <div className="space-y-8">
              ...
              <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
                ...
                <div className="space-y-4">
                  {recommendations.slice(0, 3).map((solution: any) => (
                    <div
                      key={solution._id}
                      className="flex items-center space-x-3 p-3 rounded-lg border border-gray-700 hover:border-blue-500 cursor-pointer transition-colors"
                      onClick={() => router.push(`/solutions/${solution._id}`)}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-white text-sm truncate">{solution.title}</h3>
                        <p className="text-xs text-gray-300 truncate">{solution.category}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3 p-3 bg-blue-900/30 rounded-lg">
                  <div className="w-2 h-2 bg-blue-400 rounded-full mt-2"></div>
                  <div>
                    <p className="text-sm font-medium text-blue-300">New solution approved</p>
                    <p className="text-xs text-blue-400">AI Customer Service Bot is now live</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-3 bg-green-900/30 rounded-lg">
                  <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                  <div>
                    <p className="text-sm font-medium text-green-300">Query resolved</p>
                    <p className="text-xs text-green-400">Customer found their solution</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-3 bg-yellow-900/30 rounded-lg">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full mt-2"></div>
                  <div>
                    <p className="text-sm font-medium text-yellow-300">New inquiry received</p>
                    <p className="text-xs text-yellow-400">Someone is interested in your solution</p>
                  </div>
                </div>
              </div>
            </div>
